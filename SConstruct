...
opts.Add(PathVariable("target_path", "The path where the lib is installed.", "project/Libraries/"))
opts.Add(PathVariable("target_name", "The library name.", "Gladiator-2094", PathVariable.PathAccept))
